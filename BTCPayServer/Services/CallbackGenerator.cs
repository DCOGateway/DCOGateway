...
namespace BTCPayServer.Services
{
    public class CallbackGenerator(LinkGenerator linkGenerator, UserManager<ApplicationUser> userManager)
    {
        ...
        private Exception Bug([CallerMemberName] string? name = null) => new InvalidOperationException($"Error generating link for {name} (Report this bug to DCO Gateway github repository)");
